...
$lang_module['adduser_register_openid_info'] = 'Hi %1$s,<br /><br />Your account at website %2$s activated.<br/>To log into your account please visit the page: <a href="%3$s">%3$s</a> and press the button: Sign in with %4$s.<br /><br />This is email automatic sending from website %2$s.<br /><br />Site administrator';
...
$lang_module['openid_processing_connect'] = 'Guest connects Oauth to his existing account';
$lang_module['openid_processing_create'] = 'Guest creates a new account and connects Oauth to it';
$lang_module['openid_processing_auto'] = 'The system automatically creates a new account and connects Oauth to it';
